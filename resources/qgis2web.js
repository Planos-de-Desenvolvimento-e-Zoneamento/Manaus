...
var map = new ol.Map({
    ...
    view: new ol.View({
         maxZoom: 28, minZoom: 1, projection: new ol.proj.Projection({
            code: 'EPSG:31980',
            //extent: [-647955.415610, 8198043.187453, 2078555.655831, 10344857.514020],
            units: 'm'})
    })
});

//initial view - epsg:3857 coordinates if not "Match project CRS"
map.getView().fit([829816.404721, 9652455.958978, 831006.885308, 9653112.721804], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Zoneamento do PDZ do Porto de Manaus</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (166 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 's camadas estão reunidas de acordo com os horizontes de planejamento (curto, médio e longo prazo). <br /> <br />Documento oficial publicado em: <br />https://bit.ly/pdzs_publicados ';
            }
